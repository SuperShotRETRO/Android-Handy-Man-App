...
class _MainPageBodyState extends State<MainPageBody> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RecommendedPopularServiceController>(
        init: RecommendedPopularServiceController(),
        initState: (_) {},
        builder: (recommendedPopularServiceController) {
          recommendedPopularServiceController.getData();
          return recommendedPopularServiceController.PopularServiceList.isEmpty ? CircularProgressIndicator(color: Colors.black,):Column(children: [
            //Image Carousel
            Container(
              height: Dimensions.pageView,
              child:PageView.builder(
                      controller: pageController,
                      itemCount: recommendedPopularServiceController.PopularServiceList.length,
                      itemBuilder: (BuildContext context, position) {
                        return _buildPageItem(
                            position,
                            recommendedPopularServiceController
                                .PopularServiceList[position]);
                      }),
            ),
            //Dots Indicator
            DotsIndicator(
                    dotsCount: recommendedPopularServiceController.PopularServiceList.isEmpty?1:recommendedPopularServiceController.PopularServiceList.length,
            ...
            ListView.builder(
                    ...
                    itemCount:recommendedPopularServiceController.AllServiceList.length,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          Get.toNamed(RouteHelper.getserviceDetails(
                              recommendedPopularServiceController.AllServiceList[index].id));
                        },
                        child: Container(
