  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            BigText(text: addressList[index].name),
                                            SizedBox(height: Dimensions.height10,),
                                            SmallText(text: addressList[index].addressline1),
                                            SizedBox(height: Dimensions.height10*0.5,),
                                            SmallText(text: addressList[index].addressline2),
                                            SizedBox(height: Dimensions.height10*0.5,),
                                            SmallText(text: addressList[index].city),
                                            SizedBox(height: Dimensions.height10*0.5,),
                                            SmallText(text: addressList[index].pin),
                                          ],
                                        ),
                                      ),
                                    ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Get.offNamed(RouteHelper.getMapScreen());
        },
